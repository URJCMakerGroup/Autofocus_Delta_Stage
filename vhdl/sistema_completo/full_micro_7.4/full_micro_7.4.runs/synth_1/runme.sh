...
HD_PWD='D:/carlo/UNIVERSIDAD/TFM/MICROSCOPIO/full_micro_7.4/full_micro_7.4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_microscopio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_microscopio.tcl
