...
HD_PWD='D:/carlo/UNIVERSIDAD/TFM/MICROSCOPIO/full_micro_7.4/full_micro_7.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_microscopio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_microscopio.tcl -notrace
