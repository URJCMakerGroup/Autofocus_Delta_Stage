...
entity stepper_motor is
 ...
 --    lim_sup: in std_logic;  -- indica si se ha alcanzado el limite superior de movimiento
...
begin
 ...
 stop <= '1' when endstop = '0' and dir = '0' else '0';
 funciona <= '1' when step ='1' and stop='0' else '0';
 
 s_funciona <= funciona; -- activa el contador de revoluciones en el módulo control
 movimiento <= '1' when funciona = '1' else '0';-- and lim_sup = '0' else '0'; -- activa el funcionamiento del motor
 --movimiento <= '1' when step = '1' else '0';
