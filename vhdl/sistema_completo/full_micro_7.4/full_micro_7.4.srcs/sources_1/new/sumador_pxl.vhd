...
--        end if;
--    end process;    
--    pulso_sum <= '1' when (pb_up_reg='1' and pb_up_reg2='0') else '0'; --probar directamente sin el biestable------------------------------------
...
--    maximo   <= std_logic_vector(addr_ram_aux);
    ...
    led_bram <= '1' when (addr_ram_aux > 10-1) else '0'; -----------------------------bram_num //  no me coge la libreria
end Behavioral;