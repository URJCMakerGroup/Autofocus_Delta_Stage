...
---------------------------------------------------------------------------------
  ...
  seg7_num1 <= c_rev_abs_m1(4-1 downto 0);--ov_capture_datatest(7 downto 4);
  seg7_num2 <= addr_max_aux;--ov_capture_datatest(11 downto 8);
  seg7_num3 <= test_pulso;--(others => '0');
  seg7_num4 <= pxl_sum_aux(15 downto 12);--(others => '0');
  seg7_num5 <= pxl_sum_aux(19 downto 16);--c_rev_abs_m3(4-1 downto 0);
  seg7_num6 <= pxl_sum_aux(23 downto 20);--c_rev_abs_m2(4-1 downto 0);
  seg7_num7 <= "000" & pxl_sum_aux(24);--c_rev_abs_m1(4-1 downto 0);
