...
begin
  ...
  segment <= "1000000" when num_disp="0000" else -- 0
                 "1111001" when num_disp="0001" else -- 1
                 "0100100" when num_disp="0010" else -- 2
                 "0110000" when num_disp="0011" else -- 3
                 "0011001" when num_disp="0100" else -- 4
                 "0010010" when num_disp="0101" else -- 5
                 "0000010" when num_disp="0110" else -- 6
                 "1111000" when num_disp="0111" else -- 7
                 "0000000" when num_disp="1000" else -- 8
                 "0011000" when num_disp="1001" else -- 9 
                 "0001000" when num_disp="1010" else -- A
                 "0000011" when num_disp="1011" else -- b
                 "0100111" when num_disp="1100" else -- c
                 "0100001" when num_disp="1101" else -- d
                 "0000110" when num_disp="1110" else -- E
                 "0001110"; -- F           
  seg <= segment;
