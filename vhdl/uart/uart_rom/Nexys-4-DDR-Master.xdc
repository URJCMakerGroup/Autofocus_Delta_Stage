...
##Switches
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { sw_env }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { sw_env }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { pb_down }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
